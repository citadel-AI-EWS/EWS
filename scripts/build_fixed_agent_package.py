...
def write_extras() -> None:
    ...
    readme = (
        ...
        "Произвольный SSH shell в пакет не включён. Разрешены только подписанные allowlist-команды Controller, включая безопасно ограниченные reboot/shutdown без shell.\n"
    )
