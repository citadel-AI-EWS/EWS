...
## Segment 2 — AWS account foundation (operator action)
...
## Segment 3 — Controller deployment (ready for TEST)
...
## Segment 4 — private integration test (requires AWS)
...
## Segment 5 — execution product (not implemented; release blocker)
...
## Segment 6 — identity, tenancy, and data protection (not implemented; release blocker)
...
## Segment 7 — metering and commercial readiness (not implemented; release blocker)
...
The site and Controller may be deployed now only for Segments 2–4 in a private TEST environment.
Production/customer launch remains blocked until Segments 5–7 pass. Pressure or a successful UI demo
