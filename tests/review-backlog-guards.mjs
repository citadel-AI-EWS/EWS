...
need(setup.includes("requirements-winarm64.txt"), "Windows ARM64 dependency selection missing");
need(setup.includes('$WindowsArchitecture -eq "arm64"'), "Windows ARM64 architecture gate missing");
