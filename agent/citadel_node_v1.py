...
def self_test() -> int:
    with tempfile.TemporaryDirectory() as temp:
        ...
        require_test(
            ...
            "restricted power/wake/LM Studio/hybrid commands missing",
        )
        require_test(
        ...
        require_test(
            ...
            "valid hybrid query rejected",
        )
        require_test(
            "42" in agent.python_mode_answer("calc: 6*7"),
            "bounded Python calculation failed",
        )
